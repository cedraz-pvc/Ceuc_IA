...
st.set_page_config(
    page_title="Ceuc_IA", page_icon="👩‍👧", layout="centered"
)
...
st.markdown(
    ...
    "dados, no seu ritmo.** · equipe Ceuc_IA"
)
...
if not st.session_state.get("logada"):
    ...
    st.markdown(
        ...
        **4. 🧗 Transição** — se você quer mudar de área, uma trilha objetiva em 5 fases: diagnóstico, capacitação gratuita, novo currículo com IA, rede e candidaturas.
